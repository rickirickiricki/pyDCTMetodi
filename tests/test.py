...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.output = np.array([[1.11e+03, 4.40e+01, 7.59e+01, -1.38e+02, 3.50e+00, 1.22e+02, 1.95e+02, -1.01e+02],
        ...
        self.outputMono = np.array([4.01e+02, 6.60e+00, 1.09e+02, -1.12e+02, 6.54e+01, 1.21e+02, 1.16e+02, 2.88e+01])

    def testDCT2(self):
        output = compareDCT2.myDct2(self.matrix)
        self.assertEqual(output.any(), self.output.any())

    def testMonoDCT(self):
        output = compareDCT2.dct2FromCode(self.matrix[0])
        self.assertEqual(output.any(), self.outputMono.any())
